...
resource vm1 'Microsoft.Compute/virtualMachines@2024-11-01' existing = {
  name: '${projectName}-vm1'
}

resource vm2 'Microsoft.Compute/virtualMachines@2024-11-01' existing = {
  name: '${projectName}-vm2'
}

resource vm3 'Microsoft.Compute/virtualMachines@2024-11-01' existing = {
