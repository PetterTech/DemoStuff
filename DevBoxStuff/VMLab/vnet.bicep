...
resource vmsubnet 'Microsoft.Network/virtualNetworks/subnets@2024-10-01' existing = {
  name: vNetSubnetName
  parent: vNet
}

resource bastionSubnet 'Microsoft.Network/virtualNetworks/subnets@2024-10-01' existing = {
  name: bastionSubnetName
  parent: vNet
}
